...
$ScriptRepoLocation = "https://raw.githubusercontent.com/Greyt3ch/WVD-Spring2020-Scaling/"
...
if ($RoleAssignment.RoleDefinitionName -eq "Owner" -or $RoleAssignment.RoleDefinitionName -eq "Contributor")
{
	...
	$RequiredModules = @(
        ...
        [pscustomobject]@{ ModuleName = 'Az.DesktopVirtualization'; ModuleVersion = '0.1.0' }
	)
